-- BAAP Database Seed Script
-- This script runs all seed files in the correct order to populate the LocalDB database
-- Make sure to apply EF migrations first before running this script

USE BAAP_Dev;
GO

PRINT 'Starting BAAP Database Seeding Process...'
PRINT '======================================================'
...
PRINT '======================================================'
PRINT 'BAAP Database Seeding Complete!'
