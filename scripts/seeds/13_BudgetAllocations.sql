...
(500000.00, 3200000.00, 800000.00, 400000.00, 500000.00, 'Core banking system modernization with enhanced security and compliance requirements', 2, GETDATE(), GETDATE()),

-- Budget for Assessment 3 (Healthcare)
(380000.00, 2800000.00, 620000.00, 320000.00, 480000.00, 'HIPAA-compliant healthcare platform with advanced analytics and telehealth capabilities', 3, GETDATE(), GETDATE());
