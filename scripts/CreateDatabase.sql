CREATE TABLE [Assessments] (
    ...
    [DevOpsMaturityScore] int NOT NULL,
    [DatabaseOptimizationScore] int NOT NULL,
    [DocumentationScore] int NOT NULL,
    ...
    [BusinessContextLastAiAnalysis] datetime2 NULL,
    [ArchitectureReviewLastAiAnalysis] datetime2 NULL,
    [InfrastructureLastAiAnalysis] datetime2 NULL,
    [DataArchitectureLastAiAnalysis] datetime2 NULL,
    [DevOpsLastAiAnalysis] datetime2 NULL,
    [SecurityLastAiAnalysis] datetime2 NULL,
    [CloudMigrationLastAiAnalysis] datetime2 NULL,
    [RecommendationsLastAiAnalysis] datetime2 NULL,
...
CREATE TABLE [Applications] (
    ...
    [ModernizationPriority] int NOT NULL,
    ...
    [CloudReadinessScore] int NOT NULL,
    [CriticalIssues] int NOT NULL,
    [SecurityIssues] int NOT NULL,
    [CriticalFindings] int NOT NULL,
    [HighFindings] int NOT NULL,
...
CREATE TABLE [Recommendations] (
    ...
    [Investment] nvarchar(50) NULL,
    [EstimatedROI] nvarchar(20) NULL,
    [EstimatedCost] decimal(18,2) NULL,
    [PotentialSavings] decimal(18,2) NULL,
